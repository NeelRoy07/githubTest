...
def MoveObs(car, number):
    ...
    if number % 2 == 0:
        ...
        if car.ycor() > -198:
            car.sety(car.ycor()-random.randint(5, 15))
        else:
            car.sety(198)
        ...
        if car.ycor() < 198:
            car.sety(car.ycor()+random.randint(10, 25))
        else:
            car.sety(-198)
...
def CarPos():
    my_car_dic["car_0"].goto(-290, 190)
    my_car_dic["car_1"].goto(-260, -190)
    my_car_dic["car_2"].goto(-10, 190)
    my_car_dic["car_3"].goto(310, 190)
    my_car_dic["car_4"].goto(340, -190)
    my_car_dic["car_5"].goto(-40, 190)
    ...
    if Difficulty.lower() == "hard":
        ...
        while time.time() - start < times[0] and True:
            ...
            if lives == 0:
                ...
                c.setposition(0, 0)
                c.write("You have no lives left. You lost.",
            ...
            if player.ycor() > 205 or player.ycor() < -205:
                ...
                c.setposition(0, 0)
                c.write("You went oustide the playing field. You lost.",
                        align="center", font=("Arial", 30, "normal"))
                time.sleep(2)
                return False
            ...
            if player.xcor() > 430:
                ...
                c.setposition(0, 0)
                c.write("Congradulations!!! You Won",
                        align="center", font=("Arial", 30, "normal"))
                time.sleep(2)
                return False
